...
public class Pedido {
     ...
     */
	public boolean incluirProduto(Produto novo,ItemDePedido pedido, double precoVenda) {
		
		if (quantProdutos < MAX_PRODUTOS) {
			  produtos[quantProdutos++]= novo;
			  pedido = new ItemDePedido(produtos, MAX_PRODUTOS, precoVenda);
	...
	public void mesclarProduto(Pedido outroPedido){

		outroPedido = new Pedido(dataPedido, formaDePagamento);

		if (quantProdutos > MAX_PRODUTOS ) {
			throw new IllegalStateException("Capacidade máxima de prosutos foi excedida");
		}
	...
	public void GerarRecibo(){
		for(int i=0; i<=MAX_PRODUTOS; i++){
			System.err.println("NOME DO PRODUTO:"+ produto);
			System.err.println("QUANTIDADE:"+ quantProdutos);
			System.err.println("PREÇO UNITARIO:"+ precoCusto);
